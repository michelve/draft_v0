...
<!-- Copy this file as NNNN-short-title.md (next number in sequence). -->
<!-- Fill in or remove optional sections as appropriate. -->
...
{Describe how the implementation of/compliance with the ADR can/will be confirmed. E.g., a design/code review or a test.}
