...
- **Images and icons processed by Vite** (imported in TypeScript, get content-hashed URLs): save to `src/client/assets/images/` or `src/client/assets/icons/`
    - Import in components as: `import logo from "@/assets/images/logo.svg"`
- **Fonts and static assets served at a fixed URL** (no hashing, referenced in CSS): save to `public/fonts/`
    - Reference in `src/client/custom.css` as: `url("/fonts/MyFont.woff2")`
